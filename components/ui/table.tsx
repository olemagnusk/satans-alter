...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("border-b border-coven-border bg-coven-bg", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "group transition-colors hover:bg-coven-active data-[state=selected]:bg-coven-active",
      className
    )}
    {...props}
  />
